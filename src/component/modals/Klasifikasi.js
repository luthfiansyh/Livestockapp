...
import KlasifikasiPicker from '../modalpicker/KlasifikasiPicker';

const Klasifikasi = (props) =>{

    const {navigation} = props;
    const[chooseData, setchooseData] = useState('- Klasifikasi -');
    ...
    return(
                <View style={modalstyle.container}>
                    <Text style={modalstyle.judul}>Klasifikasi*</Text>
                    <TouchableOpacity
