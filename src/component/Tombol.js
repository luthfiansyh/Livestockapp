    ...
    <View style={{flex:1}}>
      <View style={{flex: 0.5, flexDirection: 'column', justifyContent: 'flex-start'}}>
        <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
          <TouchableOpacity onPress={() => {navigation.navigate('KalkulatorBobot')}} style={{width: 156, height: 72, marginLeft: 12, marginTop: 24, borderRadius: 4, backgroundColor:'#B7B7B7', flexDirection: 'row', justifyContent: 'space-evenly'}}>
